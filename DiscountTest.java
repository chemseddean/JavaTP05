...
public class DiscountTest {
	 ...
	 @Test
	  ...
	  public void VehicleWithDiscount() {
	    ...
	    IVehicule v1 = new Car("Peugeot", 1200, discount);
	    IVehicule v2 = new Bike("Peugeot", discount);
	  ...
	  public void VehicleWithDiscount2() {
		IVehicule v1 = new Car("Peugeot", 1000, null);
		IVehicule v2 = new Bike("Peugeot", null);
