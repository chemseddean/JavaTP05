...
public class GarageTest3 {
	...
	public void firstCarByBrand() {
		IVehicule v1 = new Car("BMW", 15000, null);	//car 15000e without discount
		IVehicule v2 = new Bike("Renault", null);
		IVehicule v3 = new Bike("Renault", null);
		Garage garage = new Garage();
		garage.add(v1);
		garage.add(v2);
		garage.add(v3);
	...
	public void getValue() {
		IVehicule v1 = new Car("BMW", 15000, null);
